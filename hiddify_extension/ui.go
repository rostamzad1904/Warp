...
func (e *Warp) setFormData(data map[string]string) error {
...
func (e *Warp) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "Warp",
		Description: "Awesome Extension warp created by rostamzad1904",
		Fields: [][]ui.FormField{
			{{
...
func (e *Warp) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "Warp",
		Description: "Awesome Extension warp created by rostamzad1904",
...
func (e *Warp) addAndUpdateConsole(message ...any) {
